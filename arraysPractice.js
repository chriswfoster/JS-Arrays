...
}allArrays[0] = evenArray;
allArrays[1] = oddArray;
return allArrays;
}
...
//Write a function called maker that creates an array, fills that array with numbers from 1 to 215, then returns the array.
  ...
  //Code Here
function maker(){
  var mightyLargeArray = [];
  for (var i = 1; i <= 215; i++){
mightyLargeArray.push(i)
}return mightyLargeArray;
}
...
Loop through your devMountainEmployees until you find cahlan, then remove him from the array.*/
  ...
  //Code Here
  function removal(devMountainEmployees){
...
//Your Code Here
var user4 = {
  name: 'Rhonda McGinnis',
  email: 'tdddis33@gmail.com',
  password: 'iLoveJavaScript',
  username: 'infiniateLoop'
}; 
var user3 = {
